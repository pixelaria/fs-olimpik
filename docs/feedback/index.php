...
$form['form-1'] = array(
	'fields' => array(
      ...
      'messages' => array(
        'preg' => 'Поле возможно содержит ошибку',
	...
	'cfg' => array(
		...
		'from_name' => 'Заявка с сайта fs-olimpik.ru',
		'to_email' => 'abuse@pixelaria.ru',
		'to_name' => 'Pixelaria',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		...
		'okay' => '<div class="form__title">СПАСИБО</div><div class="form__subtitle">Мы свяжемся с вами в ближайшее время!</div>',
...
$form['form-2'] = array(
	...
	'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Запись на открытый урок',
    'title' => 'Запись на открытый урок',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'Заявка с сайта fs-olimpik.ru',
